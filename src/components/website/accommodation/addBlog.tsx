    ...
    const postPage = async () => {
        if (text == '') {
            ...
            if (docSnap.exists()) {
                ...
                await setDoc(doc(getFirestore(), "accommodation-blog", slug), { title: title, text: text, createdAt : timestamp,postedBy : ""});
            }
        }
    }
            ...
            <Grid container spacing={2} className={classes.gridContainer}>
                <Grid item xs={12} xl={6} style={{}}>
                    <div className={classes.upperSecContainer}>
                        ...
                        <TextField InputProps={{ className: classes.input }} sx={{width: '600px'}} size="small" id="title" variant="outlined" onChange={(e) => onTitleChange(e.target.value)}/>

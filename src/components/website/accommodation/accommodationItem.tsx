...
const AccommodationItem: React.FC<AccommodationItemProps> = ({ accommodation }) => {
  return (
    <div className={classes.accommodationContainer}>
        ...
        <div className={classes.imageContainer}>
            ...
            <img className={classes.image} src={accommodation.imageUrl} alt="HDB Image" width={200} height={200}></img>
        </div>

...
export default function DetailPage() {
  ...
  const [accommodation, setAccommodation] = useState<Accommodation>({id:"",category:"",compareImageUrl:""});
  ...
  querySnapshot.forEach((doc)=>{
    ...
    if(category.toLowerCase() == urlArray[3]){
      setAccommodation({id:doc.id,category:doc.data().category,compareImageUrl:doc.data().compareImageUrl})
    }
  })
  }

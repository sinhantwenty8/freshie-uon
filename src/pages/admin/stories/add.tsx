...
const Add: FunctionComponent = () => {
    ...
    /**
     * Loads data from Firestore and sets component state.
     */
            ...
            <Grid item xs={12} xl={9} style={{ paddingLeft: "30px" }}>
                ...
                <div style={{ backgroundColor: "#FFFFFF", padding: '30px', borderRadius: '4px', width: "100%" }}>
                    <div style={{ backgroundColor: "#DCE2EA", borderRadius: '4px', padding: '30px' }}>
                        <Button style={{ margin: '0 0 10px 0', color: "#000000" }} variant="text" component="label" endIcon={<DriveFolderUploadIcon />}>
                            Upload Image
                            <input
                                hidden
                                accept="image/*"
                        ...
                        <div style={{ color: "#000000", marginTop: "10px" }}>Description</div>
                        <TextField
                            fullWidth
                            id="outlined-basic"
                            variant="outlined"
